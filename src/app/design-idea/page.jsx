  ...
  return (
    <div>
      <head>
        ...
        <meta
          name="description"
          content={seoData?.metaDescription ?? "Explore Interior Design gallery for your home , designed by Top interior designers at High Creation Interior.	"}
        />
        <meta
          name="keywords"
          content={seoData?.metaKeywords ?? "design idea, living room interior, living room design, living room decor"}
        />
        <link rel="canonical" href="https://hcinterior.in/design-idea" />	
      </head>
      <MainLayout>
        <main>
          <BackgroundImageRow
